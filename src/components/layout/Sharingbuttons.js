...
const Sharingbuttons = () => {
  return (
    <Fragment>
      <div class="settings__div__sharing-buttons">
        <a
          class="share-btn__link"
          href="https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fjustcolor.zeddrix.com%2F"
          target="_blank"
          rel="noopener"
          aria-label="">
          <div class="share-btn share-btn--fb share-btn--small">
            <div aria-hidden="true" class="share-btn__icon share-btn__icon--solid">
        ...
        <a
          ...
          rel="noopener"
          aria-label="">
          <div class="share-btn share-btn--twitter share-btn--small">
            <div aria-hidden="true" class="share-btn__icon share-btn__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a
          ...
          rel="noopener"
          aria-label="">
          <div class="share-btn share-btn--tumblr share-btn--small">
            <div aria-hidden="true" class="share-btn__icon share-btn__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a
          ...
          rel="noopener"
          aria-label="">
          <div class="share-btn share-btn--email share-btn--small">
            <div aria-hidden="true"
              class="share-btn__icon share-btn__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a
          ...
          rel="noopener"
          aria-label="">
          <div class="share-btn share-btn--pinterest share-btn--small">
            <div aria-hidden="true" class="share-btn__icon share-btn__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
